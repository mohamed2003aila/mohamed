...
LuaTele = luatele.set_config{api_id=2692371,api_hash='fe85fff033dfe0f328aeb02b4f784930',session_name=Best,token=Token}
function var(value)  
...
ControllerAll = false
local ListSudos ={Sudo_Id,929431022,2069112486}  
...
Status = 0
DevelopersQ = Redis:sismember(Best.."Best:DevelopersQ:Groups",UserId) 
Developers = Redis:sismember(Best.."Best:Developers:Groups",UserId) 
TheBasics = Redis:sismember(Best.."Best:TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(Best.."Best:TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(Best.."Best:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(Best.."Best:Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(Best.."Best:Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(Best.."Best:Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(Best.."Best:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif DevelopersQ then
Status = Redis:get(Best.."Best:DevelopersQ:Groups"..ChatId) or 'المطور الثانوي'
elseif TheBasicsQ then
Status = Redis:get(Best.."Best:PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(Best.."Best:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(Best.."Best:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(Best.."Best:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(Best.."Best:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(Best.."Best:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(Best.."Best:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(Best.."Best:lockpin"..ChatId) then    
lock_pin = "【 ✅ 】"
else 
lock_pin = "【 ❌ 】"    
end
if Redis:get(Best.."Best:Lock:tagservr"..ChatId) then    
lock_tagservr = "【 ✅ 】"
else 
lock_tagservr = "【 ❌ 】"
end
if Redis:get(Best.."Best:Lock:text"..ChatId) then    
lock_text = "【 ✅ 】"
else 
lock_text = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "【 ✅ 】"
else 
lock_add = "【 ❌ 】 "    
end    
if Redis:get(Best.."Best:Lock:Join"..ChatId) == "kick" then
lock_join = "【 ✅ 】"
else 
lock_join = "【 ❌ 】 "    
end    
if Redis:get(Best.."Best:Lock:edit"..ChatId) then    
lock_edit = "【 ✅ 】"
else 
lock_edit = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Chek:Welcome"..ChatId) then
welcome = "【 ✅ 】"
else 
welcome = "【 ❌ 】 "    
end
if Redis:hget(Best.."Best:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(Best.."Best:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(Best.."Best:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(Best.."Best:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "【 ✅ 】"
else     
flood = "【 ❌ 】 "     
end
if Redis:get(Best.."Best:Lock:Photo"..ChatId) == "del" then
lock_photo = "【 ✅ 】" 
elseif Redis:get(Best.."Best:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(Best.."Best:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "【 ❌ 】 "   
end    
if Redis:get(Best.."Best:Lock:Contact"..ChatId) == "del" then
lock_phon = "【 ✅ 】" 
elseif Redis:get(Best.."Best:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "【 ❌ 】 "    
end    
if Redis:get(Best.."Best:Lock:Link"..ChatId) == "del" then
lock_links = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(Best.."Best:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:User:Name"..ChatId) == "del" then
lock_user = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:hashtak"..ChatId) == "del" then
lock_hash = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:vico"..ChatId) == "del" then
lock_muse = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "【 ❌ 】 "    
end 
if Redis:get(Best.."Best:Lock:Video"..ChatId) == "del" then
lock_ved = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Animation"..ChatId) == "del" then
lock_gif = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Sticker"..ChatId) == "del" then
lock_ste = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:geam"..ChatId) == "del" then
lock_geam = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "【 ❌ 】 "    
end    
...
if Redis:get(Best.."Best:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(Best.."Best:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "【 ❌ 】 "
end
if Redis:get(Best.."Best:Lock:forward"..ChatId) == "del" then
lock_fwd = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "【 ❌ 】 "    
end    
if Redis:get(Best.."Best:Lock:Document"..ChatId) == "del" then
lock_file = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "【 ❌ 】 "    
end    
if Redis:get(Best.."Best:Lock:Unsupported"..ChatId) == "del" then
lock_self = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(Best.."Best:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "【 ❌ 】 "    
end
if Redis:get(Best.."Best:Lock:Spam"..ChatId) == "del" then    
lock_spam = "【 ✅ 】"
elseif Redis:get(Best.."Best:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(Best.."Best:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(Best.."Best:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "【 ❌ 】 "    
end        
...
return{
BanAll = Redis:sismember(Best.."Best:BanAll:Groups",UserId) ,
ktmall = Redis:sismember(Best.."Best:ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(Best.."Best:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(Best.."Best:SilentGroup:Group"..ChatId,UserId)
}
end
...
if data.sender.chat_id ~= Redis:get(Best.."chadmin"..msg_chat_id) then
...
elseif Redis:sismember(Best.."Best:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(Best.."Best:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(Best.."Best:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(Best.."Best:PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(Best.."Best:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(Best.."Best:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(Best.."Best:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(Best.."Best:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(Best.."Best:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(Best.."Best:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(Best.."Best:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(Best.."Best:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(Best.."Best:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(Best.."Best:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(Best) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(Best.."Best:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(Best.."Best:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if text then Redis:incrby(Best.."Best:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id, 1) end
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(Best.."Best:Status:Welcome"..msg_chat_id) then
local ban = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(Best.."Best:Welcome:Group"..msg_chat_id)
if Welcome then 
if ban.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(Best) then
return false
end
local floods = Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(Best.."Best:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(Best.."Best:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(Best.."Best:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(Best.."Best:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(Best.."Best:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Best.."Best:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Best.."Best:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(Best.."Best:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(Best.."Best:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(Best.."Best:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(Best.."Best:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(Best.."Best:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(Best.."Best:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(Best.."Best:lockpin"..msg_chat_id)
...
Redis:incr(Best.."Best:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(Best.."Best:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(Best.."Best:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(Best.."Best:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Videonote_Group = Redis:get(Best.."Best:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(Best.."Best:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(Best.."Best:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(Best.."Best:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(Best.."Best:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(Best.."Best:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(Best.."Best:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(Best.."Best:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(Best.."Best:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(Best.."Best:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(Best.."Best:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(Best.."Best:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(Best.."Best:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(Best.."Best:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(Best.."Best:Lock:Cmd"..msg_chat_id)
...
if (Redis:get(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(Best.."Best:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(Best.."Best:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(Best.."Best:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(Best.."Best:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ ارسل تحذير『 "..Filters.." 』عند ارساله*","md",true)  
end
end
if text and (Redis:get(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(Best.."Best:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(Best.."Best:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ تم اضافه رد التحذير*","md",true)  
end
if text and (Redis:get(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(Best.."Best:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(Best.."Best:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(Best.."Best:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(Best.."Best:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(Best.."Best:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(Best.."Best:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(Best.."Best:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(Best.."Best:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(Best.."Best:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(Best.."Best:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Best.."Best:All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(Best.."Best:All:Get:Reides:Commands:Group"..text)
Redis:del(Best.."Best:All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Best.."Best:All:Command:List:Group",text)
...
Redis:del(Best.."Best:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Best.."Best:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Best.."Best:All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Best.."Best:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Best.."Best:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Best.."Best:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Best.."Best:All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Best.."Best:All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(Best.."Best:All:Command:List:Group",text)
Redis:del(Best.."Best:All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ الامر باسم ⇦『 "..text..' 』*',"md",true)
end

if text and Redis:get(Best.."Best:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(Best.."Best:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(Best.."Best:Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم ازالة هاذا ⇦『 "..text.." 』*","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ لا يوجد امر بهاذا الاسم*","md",true)
end
Redis:del(Best.."Best:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(Best.."Best:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(Best.."Best:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(Best.."Best:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(Best.."Best:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ ارسل الامر الجديد ليتم وضعه مكان القديم*","md",true)  
end
if text and Redis:get(Best.."Best:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(Best.."Best:Command:Reids:Group:New"..msg_chat_id)
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(Best.."Best:Command:List:Group"..msg_chat_id,text)
Redis:del(Best.."Best:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ الامر باسم ⇦『 "..text..' 』*',"md",true)
end
if Redis:get(Best.."Best:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(Best.."Best:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(Best.."Best:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(Best.."Best:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:del(Best.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(Best.."Best:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ ترحيب المجموعه*","md",true)     
end
if Redis:get(Best.."Best:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Best.."Best:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم الغاء حفظ القوانين*","md",true)   
end 
Redis:set(Best.."Best:Group:Rules" .. msg_chat_id,text) 
Redis:del(Best.."Best:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حفظ قوانين المجموعه*","md",true)  
end  
if Redis:get(Best.."Best:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(Best.."Best:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(Best.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Best.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(Best.."Best:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(Best.."Best:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(Best.."Best:PinMsegees:"..v,text)
end
end
...
if Redis:get(Best.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Best.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Best.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Best.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
if Redis:get(Best.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Best.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(Best.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == '〘 الغاء الامر 〙' then   
Redis:del(Best.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في قائمه الردود العامه *","md",true)  
end
end
if text then
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(Best..'GetTexting:DevBest'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر ⦁ ' then 
Redis:del(Best..'GetTexting:DevBest'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'* ⦁ تم الغاء حفظ كليشة المطور*')
end
Redis:set(Best..'Texting:DevBest',text)
Redis:del(Best..'GetTexting:DevBest'..msg_chat_id..':'..msg.sender.user_id)
...
if Redis:get(Best.."Best:Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Best.."Best:Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n ⦁ تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(Best.."Best:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(Best.."Best:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, " ⦁ تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(Best.."Best:Game:Smile"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Smile"..msg.chat_id) then
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Best.."Best:Game:Smile"..msg.chat_id)
...
if Redis:get(Best.."Best:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Monotonous"..msg.chat_id) then
Redis:del(Best.."Best:Game:Monotonous"..msg.chat_id)
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Best.."Best:Game:Riddles"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Riddles"..msg.chat_id) then
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Best.."Best:Game:Riddles"..msg.chat_id)
...
if Redis:get(Best.."Best:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Meaningof"..msg.chat_id) then
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Best.."Best:Game:Meaningof"..msg.chat_id)
...
if Redis:get(Best.."Best:Game:Reflection"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Reflection"..msg.chat_id) then
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(Best.."Best:Game:Reflection"..msg.chat_id)
...
if Redis:get(Best.."Best:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ عذرا لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(Best.."Best:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(Best.."Best:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Best.."Best:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(Best.."Best:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(Best.."Best:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(Best.."Best:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(Best.."Best:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(Best.."Best:Game:Difference"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Difference"..msg.chat_id) then 
Redis:del(Best.."Best:Game:Difference"..msg.chat_id)
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(Best.."Best:Game:Example"..msg.chat_id) then
if text == Redis:get(Best.."Best:Game:Example"..msg.chat_id) then 
Redis:del(Best.."Best:Game:Example"..msg.chat_id)
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(Best.."Best:All:Get:Reides:Commands:Group"..text) or Redis:get(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Y = Y + 1
Redis:sadd(Best..'Best:Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(Best.."Best:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(Best.."Best:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(Best.."Best:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(Best.."Best:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(Best.."Best:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(Best.."Best:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(Best.."Best:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(Best.."Best:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(Best.."Best:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(Best.."Best:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(Best.."Best:TheBasics:Group"..idg,idASAS)
end;end
end
...
--os.execute('rm -rf Best.lua')
--download('https://raw.githubusercontent.com/JABWA-Best/JEKA/master/Best.lua','Best.lua')
...
Redis:set(Best.."Best:SendBcBot",true) 
...
Redis:set(Best.."Best:LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(Best.."Best:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(Best.."Best:AddSudosNew"..msg_chat_id)
...
Redis:set(Best.."Best:AddSudosNew"..msg_chat_id,true)
...
local Groups = Redis:smembers(Best..'Best:ChekBotAdd')  
local UsersBot = Redis:smembers(Best..'Best:Num:User:Pv')  
...
local President = Redis:smembers(Best.."Best:TheBasics:Group"..v)
local Constructor = Redis:smembers(Best.."Best:Originators:Group"..v)
local Manager = Redis:smembers(Best.."Best:Managers:Group"..v)
local Admin = Redis:smembers(Best.."Best:Addictive:Group"..v)
local Vips = Redis:smembers(Best.."Best:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
Redis:set(Best..'Best:Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
NamesBot = (Redis:get(Best.."Best:Name:Bot") or "بيست")
Groups = (Redis:scard(Best..'Best:ChekBotAdd') or 0)
Users = (Redis:scard(Best..'Best:Num:User:Pv') or 0)
...
{
{text = Jabwa, url = 't.me/QQWGT2'}, 
},
{
{text = Grosupsw, url = 't.me/QQWGT2'}, 
},
{
{text = Usperos, url = 't.me/QQWGT2'}, 
},
}
...
if Redis:sismember(Best.."Best:ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(Best..'Best:Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,' ⦁ عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(Best..'Best:Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(Best.."Best:ChekBotAdd",msg_chat_id)
Redis:set(Best.."Best:Status:Id"..msg_chat_id,true) ;Redis:set(Best.."Best:Status:Reply"..msg_chat_id,true) ;Redis:set(Best.."Best:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(Best.."Best:Status:BanId"..msg_chat_id,true) ;Redis:set(Best.."Best:Status:SetId"..msg_chat_id,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(Best.."Best:ChekBotAdd",msg_chat_id) then
...
Redis:srem(Best.."Best:ChekBotAdd",msg_chat_id)
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ اسم المجموعه -›『*['..Get_Chat.title..']('..Info_Chats.invite_link.invite_link..')*』\n ⦁ تم التعطيل من قبل *','md',true)
end
end
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(Best.."Best:ChekBotAdd",msg_chat_id) then
if text == "ايدي" and msg.reply_to_message_id == 0 then
if not Redis:get(Best.."Best:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local TotalMsg = Redis:get(Best..'Best:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(Best..'Best:Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(Best.."Best:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(Best.."Best:Set:Id:Groups") or Redis:get(Best.."Best:Set:Id:Group"..msg_chat_id)
if Redis:get(Best.."Best:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(Best..'Best:Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(Best..'Best:Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(Best.."Best:Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(Best.."Best:Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
if not Redis:get(Best.."Best:Status:IdPhoto"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if not Redis:sismember(Best.."Best:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Best.."Best:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"* ⦁ تم تنزيله مطور ثانوي مسبقا *").Reply,"md",true)  
else
Redis:srem(Best.."Best:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(Best.."Best:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Developers:Groups",UserId) 
...
if not Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(Best.."Best:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Best.."Best:Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(Best.."Best:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(Best.."Best:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Developers:Groups",UserId) 
...
if Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2]," ⦁ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(Best.."Best:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(Best.."Best:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Best.."Best:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Best.."Best:PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Best.."Best:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(Best.."Best:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(Best.."Best:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(Best.."Best:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(Best.."Best:Developers:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(Best.."Best:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(Best.."Best:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تفعيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(Best.."Best:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Status:Id"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Status:Reply"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Status:BanId"..msg_chat_id,true) 
...
Redis:set(Best.."Best:BotFree",true) 
...
Redis:set(Best.."Best:TwaslBot",true) 
...
if TextMsg == 'الرابط' then
Redis:del(Best.."Best:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم تعطيل الرابط *","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(Best.."Best:Status:Welcome"..msg_chat_id) 
...
Redis:del(Best.."Best:Status:Id"..msg_chat_id) 
...
Redis:del(Best.."Best:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(Best.."Best:Status:Reply"..msg_chat_id) 
...
Redis:del(Best.."Best:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(Best.."Best:Status:BanId"..msg_chat_id) 
...
if not Redis:sismember(Best.."Best:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(Best.."Best:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(Best.."Best:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(Best.."Best:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Best.."Best:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(Best.."Best:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(Best.."Best:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(Best.."Best:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(Best.."Best:MosTafa:Ahmed"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(Best.."Best:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(Best.."Best:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(Best.."Best:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId," ⦁ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(Best.."Best:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(Best.."Best:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Best.."Best:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(Best.."Best:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(Best.."Best:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(Best.."Best:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if not Redis:get(Best.."Best:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Best.."Best:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Best.."Best:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local zwgat_list = Redis:smembers(Best..msg_chat_id.."zwgat:")
...
local lonely_list = Redis:smembers(Best..msg_chat_id.."lonely:")
...
local mutlqat_list = Redis:smembers(Best..msg_chat_id.."mutlqat:")
...
local klbklb_list = Redis:smembers(Best..msg_chat_id.."klbklb:")
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Best.."chadmin"..msg_chat_id),"md",true)  
end
...
Redis:set(Best.."Best:Lock:text"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(Best.."Best:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(Best.."Best:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(Best.."Best:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(Best.."Best:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(Best.."Best:Lock:edit"..msg_chat_id,true) 
...
Redis:set(Best.."Best:Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Best..'Best:'..lock..msg_chat_id,"del")    
end
...
Redis:del(Best.."Best:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(Best.."Best:Lock:text"..msg_chat_id)  
...
Redis:del(Best.."Best:Lock:Join"..msg_chat_id)  
...
Redis:del(Best.."Best:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(Best.."Best:Lock:tagservr"..msg_chat_id)  
...
Redis:del(Best.."Best:lockpin"..msg_chat_id)  
...
Redis:del(Best.."Best:Lock:edit"..msg_chat_id) 
...
Redis:del(Best.."Best:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(Best..'Best:'..lock..msg_chat_id)    
end
...
Redis:hset(Best.."Best:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(Best.."Best:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(Best.."Best:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(Best.."Best:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(Best.."Best:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(Best.."Best:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Link"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:User:Name"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:hashtak"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Cmd"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Photo"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Video"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Animation"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:geam"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Audio"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:vico"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Sticker"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:forward"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Document"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Contact"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Spam"..msg_chat_id)  
...
Redis:set(Best.."Best:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(Best.."Best:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(Best.."Best:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(Best.."Best:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(Best.."Best:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(Best.."Best:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(Best.."Best:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
{{text =Get_Chat.title, url = GetLink}, },}}
return LuaTele.sendText(msg_chat_id, msg_id, " \n["..Get_Chat.title.. ']('..GetLink..')', 'md', true, false, false, false, reply_markup)
...
if not Redis:get(Best.."Best:Status:Welcome"..msg_chat_id) then
...
Redis:del(Best.."Best:Welcome:Group"..msg_chat_id) 
...
Redis:setex(Best.."Best:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(Best.."Best:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(Best.."Best:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(Best.."Best:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Best.."Best:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(Best.."Best:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(Best.."Best:Filter:Group:"..v..msg_chat_id)  
Redis:srem(Best.."Best:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(Best.."Best:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(Best..'Best:FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ⦁ ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(Best.."Best:All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(Best.."Best:All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(Best.."Best:All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(Best.."Best:All:Get:Reides:Commands:Group"..v)
Redis:del(Best.."Best:All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(Best.."Best:All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(Best.."Best:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(Best.."Best:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(Best.."Best:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(Best.."Best:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ⇦ {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
if Redis:get(Best.."Best:Status:Link"..msg.chat_id) then
Statuslink = '【 ✅ 】' else Statuslink = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:Welcome"..msg.chat_id) then
StatusWelcome = '【 ✅ 】' else StatusWelcome = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:Id"..msg.chat_id) then
StatusId = '【 ✅ 】' else StatusId = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '【 ✅ 】' else StatusIdPhoto = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:Reply"..msg.chat_id) then
StatusReply = '【 ✅ 】' else StatusReply = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '【 ✅ 】' else StatusReplySudo = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:BanId"..msg.chat_id)  then
StatusBanId = '【 ✅ 】' else StatusBanId = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:SetId"..msg.chat_id) then
StatusSetId = '【 ✅ 】' else StatusSetId = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:Games"..msg.chat_id) then
StatusGames = '【 ✅ 】' else StatusGames = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:KickMe"..msg.chat_id) then
Statuskickme = '【 ✅ 】' else Statuskickme = '【 ❌ 】'
end
if Redis:get(Best.."Best:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(Best.."Best:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(Best.."Best:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(Best.."Best:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(Best.."Best:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(Best.."Best:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(Best.."Best:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(Best.."Best:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
Redis:del(Best..'Best:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع رسائلك *',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(Best..'Best:Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع تعديلاتك *',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(Best..'Best:Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ تم مسح جميع جهاتك المضافه *',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد رسائلك هنا ⇦ '..(Redis:get(Best..'Best:Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد التعديلات هنا ⇦ '..(Redis:get(Best..'Best:Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد جهاتك يبشا ⇦ '..(Redis:get(Best.."Best:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:setex(Best.."Best:Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
...
Redis:del(Best.."Best:Set:Id:Groups")
...
Redis:setex(Best.."Best:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
 ⦁ ارسل الان النص
 ⦁ يمكنك اضافه :
 ⦁ `#username` » اسم المستخدم
...
Redis:del(Best.."Best:Set:Id:Group"..msg.chat_id)
...
🇫🇷• 𝐒𝐓𝐀𝐒𝐓 𖠰 #stast .
  ...
  Redis:set(Best.."Best:Set:Id:Group"..msg.chat_id, id_text[math.random(12)])
...
Redis:del(Best.."Best:DevelopersQ:Groups") 
...
Redis:del(Best.."Best:Developers:Groups") 
...
Redis:del(Best.."Best:TheBasics:Group"..msg_chat_id) 
...
Redis:del(Best.."Best:Originators:Group"..msg_chat_id) 
...
Redis:del(Best.."Best:Managers:Group"..msg_chat_id) 
...
Redis:del(Best.."Best:Addictive:Group"..msg_chat_id) 
...
Redis:del(Best.."Best:Distinguished:Group"..msg_chat_id) 
...
Redis:del(Best.."Best:BanAll:Groups") 
...
Redis:del(Best.."Best:ktmAll:Groups") 
...
Redis:del(Best.."Best:BanGroup:Group"..msg_chat_id) 
...
local Info_Members = Redis:smembers(Best.."Best:MosTafa:Ahmed"..msg_chat_id) 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ لا يوجد مطردين في المجموعه ","md",true)  
end
Redis:del(Best.."Best:MosTafa:Ahmed"..msg_chat_id) 
...
Redis:del(Best.."Best:SilentGroup:Group"..msg_chat_id) 
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(Best..'Channel:Join')}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
...
Redis:setex(Best.."Bc:Grops:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
...
Redis:setex(Best.."Send:Bc:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Best.."Send:Bc:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[*
...
Redis:setex(Best.."Send:Fwd:Grops" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(Best.."Send:Fwd:Pv" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(Best..'Best:GetTexting:DevBest'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(Best..'Best:Texting:DevBest')
...
local TextingDevBest = Redis:get(Best..'Best:Texting:DevBest')
...
return LuaTele.sendText(msg_chat_id,msg_id,'⦁ اليك قسم الالعاب من سورس بيست ⦁',"md",false, false, false, false, reply_markup)
end
...
if Redis:get(Best.."Status:kool"..msg.chat_id) then
...
if tonumber(Message_Reply.sender.user_id) == tonumber(Best) then
return LuaTele.sendText(msg_chat_id,msg_id,"*شوفلك كلبه غير البوت يبنوسخه 😒*","md",true)  
end
if Redis:sismember(Best..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
local rd_mtzwga = {
...
if Redis:sismember(Best..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) then 
Redis:srem(Best..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id)
end
Redis:sadd(Best..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best..msg_chat_id.."zwgat:",Message_Reply.sender.user_id) then
Redis:srem(Best..msg_chat_id.."zwgat:",Message_Reply.sender.user_id)
Redis:sadd(Best..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
local rd_tmtlaq = {
...
if Redis:sismember(Best..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(Best..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Best..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(Best..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(Best..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Best..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(Best..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Best..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(Best..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(Best..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if not Redis:get(Best.."Best:Sourc_rd"..msg_chat_id) then
...
Redis:setex(Best.."Best:Change:Best:Name:Bot"..msg.sender.user_id,300,true) 
...
local NamesBot = (Redis:get(Best.."Best:Name:Bot") or "بيست")
local BotName = {
...
local NamesBot = UserInfo.first_name
if photo.total_count > 0 then
local keyboard = {} 
keyboard.inline_keyboard = {
{
{text = NamesBot , url = 't.me/QQWGT2'}, 
},
{
...
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(BotName[math.random(#BotName)]).."&reply_to_message_id="..rep.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
if text == (Redis:get(Best.."Best:Name:Bot") or "بيست") then
local photo = LuaTele.getUserProfilePhotos(Best)
local UserInfo = LuaTele.getUser(Best)
for Name_User in string.gmatch(UserInfo.first_name, "[^%s]+" ) do
UserInfo.first_name = Name_User
...
if not msg.ControllerBot and not Redis:set(Best.."Best:LeftBot") then
...
local list = Redis:smembers(Best.."Best:Num:User:Pv")   
local x = 0
for k,v in pairs(list) do  
...
x = x + 1
Redis:srem(Best..'Best:Num:User:Pv',v)
end
end
if x ~= 0 then
...
local list = Redis:smembers(Best.."Best:ChekBotAdd")   
local x = 0
for k,v in pairs(list) do  
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
...
Redis:srem(Best..'Best:ChekBotAdd',Get_Chat.id)
...
Redis:srem(Best..'Best:ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(Best.."Best:Game:Smile"..msg.chat_id,SM)
...
Redis:set(Best.."Best:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(Best.."Best:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(Best.."Best:Status:Games"..msg.chat_id) then
Redis:del(Best.."Best:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(Best.."Best:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(Best.."Best:Status:Games"..msg.chat_id) then
Redis:del(Best.."Best:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(Best.."Best:Game:Reflection"..msg.chat_id,name)
...
Redis:set(Best.."Best:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(Best.."Best:Game:Difference"..msg.chat_id,name)
...
Redis:set(Best.."Best:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(Best.."Best:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(Best.."Best:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(Best.."Best:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(Best.."Best:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر', 'الردود')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس', 'مسح رسائلي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط', 'رفع مطور')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ', 'غنيلي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد', 'اضف رد')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر', 'الرابط')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي', 'رفع مطور ثانوي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح', 'مسح سكحاتي')
Redis:set(Best.."Best:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،', 'مسح المكتومين')
return LuaTele.sendText(msg_chat_id,msg_id,[[*
...
if text == '/start' then
Redis:sadd(Best..'Best:Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(Best.."Best:Start:Bot") then
local CmdStart = '*\n ⦁ أهلآ بك في بوت '..(Redis:get(Best.."Best:Name:Bot") or "بيست")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(Best.."Best:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
Redis:setex(Best.."Best:Change:Start:Bot"..msg.sender.user_id,300,true) 
...
Redis:set(Best.."Best:Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الان الكلمه لاضافتها في الردود العامه ","md",true)  
end
if text == '『 حذف رد عام 』' then 
if not msg.ControllerBot then 
...
Redis:set(Best.."Best:Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
return LuaTele.sendText(msg_chat_id,msg_id," ⦁ ارسل الان الكلمه لحذفها من الردود العامه","md",true)  
end
if text=='『 اذاعه خاص 』' then 
if not msg.ControllerBot then 
...
local list = Redis:smembers(Best.."Best:List:Rd:Sudo")
text = "\nقائمة الردود العامه ⇧⇩ \n⩹┉┉┉┉⊶❲sᴏᴜʀᴄᴇ ʙᴇsᴛ❳⊷┉┉┉┉⩺\n"
for k,v in pairs(list) do
if Redis:get(Best.."Best:Add:Rd:Sudo:Gif"..v) then
db = "متحركه"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:vico"..v) then
db = "رساله صوتيه "
elseif Redis:get(Best.."Best:Add:Rd:Sudo:stekr"..v) then
db = "ملصق"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:Text"..v) then
db = "رساله"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:Photo"..v) then
db = "صوره"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:Video"..v) then
db = "فيديو"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:File"..v) then
db = "ملف"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:Audio"..v) then
db = "اغنيه"
elseif Redis:get(Best.."Best:Add:Rd:Sudo:video_note"..v) then
db = "رسالة فيديو"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
local list = Redis:smembers(Best.."Best:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(Best.."Best:Add:Rd:Sudo:Gif"..v)   
Redis:del(Best.."Best:Add:Rd:Sudo:vico"..v)   
Redis:del(Best.."Best:Add:Rd:Sudo:stekr"..v)     
Redis:del(Best.."Best:Add:Rd:Sudo:Text"..v)   
Redis:del(Best.."Best:Add:Rd:Sudo:Photo"..v)
Redis:del(Best.."Best:Add:Rd:Sudo:Video"..v)
Redis:del(Best.."Best:Add:Rd:Sudo:File"..v)
Redis:del(Best.."Best:Add:Rd:Sudo:Audio"..v)
Redis:del(Best.."Best:Add:Rd:Sudo:video_note"..v)
Redis:del(Best.."Best:List:Rd:Sudo")
end
...
if not msg.ControllerBot then
if Redis:get(Best.."Best:TwaslBot") and not Redis:sismember(Best.."Best:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(Best.."Best:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(Best.."Best:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
Redis:sadd(Best..'Best:BaN:In:Tuasl',Info_User)  
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Info_User,' ⦁ تم حظره من تواصل البوت ').Reply,"md",true)  
end 
if text =='الغاء الحظر' or text =='الغاء حظر' then
Redis:srem(Best..'Best:BaN:In:Tuasl',Info_User)  
...
Redis:srem(Best.."Best:ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(Best..'*'..'-100'..data.supergroup.id..'*')
Redis:del(Best.."Best:List:Manager"..'-100'..data.supergroup.id)
Redis:del(Best.."Best:Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(Best.."Best:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(Best.."Best:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(Best.."Best:Lock:tagservr"..data.message.chat_id) then
...
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(Best..'Best:Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(Best..'Best:Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(Best.."Best:Lock:edit"..data.chat_id) then
...
Redis:del(Best.."Best:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Best.."Saidi1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Best.."Best:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Best.."Best:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Best.."Saidi1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Best.."Best:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Best.."Best:Set:Rd"..IdUser..":"..ChatId,true)
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
Redis:incrby(Best.."Best:Num:Add:Games"..ChatId..IdUser, 1)  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Best.."Best:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Best.."Best:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Best.."Best:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(Best.."Best:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Sourc_rd"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Sourc_rd"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(Best.."Best:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(Best.."Best:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(Best.."Best:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(Best.."Best:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(Best..'Best:'..lock..UserId[2],"del")    
end
...
Redis:srem(Best.."Best:SilentGroup:Group"..ChatId,listYt[2]) 
Redis:srem(Best.."Best:BanGroup:Group"..ChatId,listYt[2]) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(Best.."Best:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:Redisa:Groups") 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"* ⦁ تم مسح المحظورين *", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(Best.."Best:SilentGroup:Group"..ChatId) 
